...
class FeedbacksSearch extends Feedbacks
{
    ...
    {
        return [
            [['id', 'user_id', 'kindergarten_id'], 'integer'],
            [['images', 'phone', 'subject', 'message', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = Feedbacks::find()->with('kindergarten', 'user')->orderBy(['created_at' => SORT_DESC]);
